...
class RAGServiveProposal:
    ...
    def __init__(self, model_name: str = "llama3.2:1b"):
        ...
        self.tuk_keywords = [
            'tuk', 'technical university of kenya', 'kenya', 'exam', 'registration',
            ...
            'graduation', 'degree', 'diploma', 'upgrade', 'eveluation'
        ] 
        ...
        self.easter_eggs = {
            ...
            "what can you do": (
                ...
                ". Explain registration facilities\n"
            ...
            CRITICAL RULES:
            1. Only answe using information fro the context below
            ...
            ANSWER (with source citations): """
                    ...
                    stats = self.vector_store.get_status()
                ...
                def get_conversation_history(self, session_id:str, limit: int = 5) -> str:
                    if session_id nt in conversation_memory:
                ...
                def _log_query_safely(self, session_id: str, question: str, answer: str,
                    ...
                    is a nice-to-have for the admin panel, not a dependency of the core chat feature.
                    """
                ...
                def answer_question(self, question: str, session_id: str = "default", k: int = 5) -> Dict[str, Any]:
                    ...
                    if not self._is_tuk_related(question_lower) and len(question_lower) > 5:
                        off_topic_msg = "I'm TUK-Convosearch. I can only answer question about TU-K related topics."
                        self._long_query_safely(session_id, question, off_topic_msg, [], 0, 0.0)
                        return {
                ...
                def stream_answer(self, question:str, session_id: str = "default", k:int = 5) -> Generator[Dict[str, Any], None, None]:
                    ...
                    The chat_proposal.py endpoint turn these into Server-Sent Event Cachingband conversation history are updated exactly as in answer_question, so both code paths stay consistent.
                    """
                    ...
                    easter_egg_reply = self._check_easter_egg(question_lower)
                    if easter_egg_reply:
                        self.log_query_safely(session_id, question, easter_egg_reply, [], 0, 0.0)
                    ...
                    if not self._is_tuk_related(question_lower) and len(question_lower) > 5:
                        ...
                        self.log_query_safely(session_id, question, msg, [], 0, 0.0)
                        yield{'type': 'sources', 'sources': [], 'chunks_found':0}
                ...
                try:
                    ...
                    full_answer = "".john(full_answer_parts)
